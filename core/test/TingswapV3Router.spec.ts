...
describe('TingswapV3Pool', () => {
  ...
  let pool0: MockTimeTingswapV3Pool
  let pool1: MockTimeTingswapV3Pool
  ...
  let swapTargetCallee: TestTingswapV3Callee
  let swapTargetRouter: TestTingswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeTingswapV3Pool, any]> => {
